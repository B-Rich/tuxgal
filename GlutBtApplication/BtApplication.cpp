...
void BtApplication::overrideGLShapeDrawer (GL_ShapeDrawer* shapeDrawer)
{
...
void BtApplication::myinit(void)
{
...
void	BtApplication::setCameraDistance(float dist)
{
	m_cameraDistance  = dist;
}

float	BtApplication::getCameraDistance()
{
...
void BtApplication::reshape(int w, int h) 
{
...
void BtApplication::keyboardCallback(unsigned char key, int x, int y)
{
	(void)x;
	(void)y;
...
void	BtApplication::setDebugMode(int mode)
{
	m_debugMode = mode;
	if (getDynamicsWorld() && getDynamicsWorld()->getDebugDrawer())
...
void BtApplication::moveAndDisplay()
{
	if (!m_idle)
...
void BtApplication::displayCallback()
{
}

#define NUM_SPHERES_ON_DIAGONAL 9

void	BtApplication::setShootBoxShape ()
{
	if (!m_shootBoxShape)
	{
...
void	BtApplication::shootBox(const btVector3& destination)
{
...
btVector3	BtApplication::getRayTo(int x,int y)
{
...
void BtApplication::pickObject(const btVector3& pickPos, const btCollisionObject* hitObj)
{
...
void BtApplication::removePickingConstraint()
{
...
void	BtApplication::mouseMotionFunc(int x,int y)
{
...
btRigidBody*	BtApplication::localCreateRigidBody(float mass, const btTransform& startTransform,btCollisionShape* shape)
{
...
void BtApplication::setOrthographicProjection() 
{
...
void BtApplication::resetPerspectiveProjection() 
{
...
void BtApplication::displayProfileString(int xOffset,int yStart,char* message)
{
...
void BtApplication::showProfileInfo(int& xOffset,int& yStart, int yIncr)
{
#ifndef BT_NO_PROFILE
...
void	BtApplication::clientResetScene()
{
	removePickingConstraint();
