#ifndef TUX_INPUT_MANAGER_H
#define TUX_INPUT_MANAGER_H
...
class tuxInputManager : public OIS::KeyListener, public OIS::MouseListener, public OIS::JoyStickListener {
public:
    virtual ~tuxInputManager( void );
    ...
    static tuxInputManager* getSingletonPtr( void );
private:
    tuxInputManager( void );
    tuxInputManager( const tuxInputManager& ) { }
    tuxInputManager & operator = ( const tuxInputManager& );
    ...
    static tuxInputManager *mtuxInputManager;
};

#endif // TUX_INPUT_MANAGER_H
